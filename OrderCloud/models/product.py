...
class Product(object):
    ...
    """
    def __init__(self, id=None, name=None, description=None, quantity_multiplier=None, ship_weight=None, active=None, type=None, inventory_enabled=None, inventory_notification_point=None, variant_level_inventory=None, spec_count=None, xp=None, allow_order_exceed_inventory=None, inventory_visible=None, variant_count=None):
        """
