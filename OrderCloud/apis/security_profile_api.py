...
class SecurityProfileApi(object):
    ...
    def list_assignments(self, **kwargs):
        ...
        :param str user_id: ID of the user.
        :param str user_group_id: ID of the user group.
        :param str commerce_role: Commerce role of the security profile assignment. Possible values: Buyer, Seller, Supplier.
        :param str level: Level of the security profile assignment. Possible values: User, Group, Company.
        :param int page: Page of results to return. Default: 1
        :param int page_size: Number of results to return per page. Default: 20, max: 100.
    ...
    def save_assignment(self, security_profile_assignment, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save_assignment(security_profile_assignment, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param SecurityProfileAssignment security_profile_assignment:  (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.save_assignment_with_http_info(security_profile_assignment, **kwargs)
        else:
            (data) = self.save_assignment_with_http_info(security_profile_assignment, **kwargs)
            return data

    def save_assignment_with_http_info(self, security_profile_assignment, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save_assignment_with_http_info(security_profile_assignment, callback=callback_function)
        ...
        all_params = ['security_profile_assignment']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        for key, val in iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'security_profile_assignment' is set
        if ('security_profile_assignment' not in params) or (params['security_profile_assignment'] is None):
            raise ValueError("Missing the required parameter `security_profile_assignment` when calling `save_assignment`")
        ...
        body_params = None
        if 'security_profile_assignment' in params:
            body_params = params['security_profile_assignment']
