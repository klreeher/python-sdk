...
class BuyerApi(object):
    ...
    def create(self, buyer, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create(buyer, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param Buyer buyer:  (required)
        :return: Buyer
        ...
        if kwargs.get('callback'):
            return self.create_with_http_info(buyer, **kwargs)
        else:
            (data) = self.create_with_http_info(buyer, **kwargs)
            return data

    def create_with_http_info(self, buyer, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_with_http_info(buyer, callback=callback_function)
        ...
        if ('buyer' not in params) or (params['buyer'] is None):
            raise ValueError("Missing the required parameter `buyer` when calling `create`")
    ...
    def patch(self, buyer_id, partial_buyer, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch(buyer_id, partial_buyer, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str buyer_id: ID of the buyer. (required)
        :param Buyer partial_buyer:  (required)
        :return: Buyer
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.patch_with_http_info(buyer_id, partial_buyer, **kwargs)
        else:
            (data) = self.patch_with_http_info(buyer_id, partial_buyer, **kwargs)
            return data

    def patch_with_http_info(self, buyer_id, partial_buyer, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_with_http_info(buyer_id, partial_buyer, callback=callback_function)
        ...
        all_params = ['buyer_id', 'partial_buyer']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        # verify the required parameter 'partial_buyer' is set
        if ('partial_buyer' not in params) or (params['partial_buyer'] is None):
            raise ValueError("Missing the required parameter `partial_buyer` when calling `patch`")
        ...
        body_params = None
        if 'partial_buyer' in params:
            body_params = params['partial_buyer']
    ...
    def save(self, buyer_id, buyer, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save(buyer_id, buyer, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.save_with_http_info(buyer_id, buyer, **kwargs)
        else:
            (data) = self.save_with_http_info(buyer_id, buyer, **kwargs)
            return data

    def save_with_http_info(self, buyer_id, buyer, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save_with_http_info(buyer_id, buyer, callback=callback_function)
        ...
        # verify the required parameter 'buyer' is set
        if ('buyer' not in params) or (params['buyer'] is None):
            raise ValueError("Missing the required parameter `buyer` when calling `save`")
