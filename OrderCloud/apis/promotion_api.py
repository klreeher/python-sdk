...
class PromotionApi(object):
    ...
    def create(self, promotion, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create(promotion, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param Promotion promotion:  (required)
        :return: Promotion
        ...
        if kwargs.get('callback'):
            return self.create_with_http_info(promotion, **kwargs)
        else:
            (data) = self.create_with_http_info(promotion, **kwargs)
            return data

    def create_with_http_info(self, promotion, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_with_http_info(promotion, callback=callback_function)
        ...
        if ('promotion' not in params) or (params['promotion'] is None):
            raise ValueError("Missing the required parameter `promotion` when calling `create`")
        ...
        body_params = None
        if 'promotion' in params:
            body_params = params['promotion']
    ...
    def list_assignments(self, **kwargs):
        ...
        :param str user_id: ID of the user.
        :param str user_group_id: ID of the user group.
        :param str level: Level of the promotion assignment. Possible values: User, Group, Company.
        :param int page: Page of results to return. Default: 1
        :param int page_size: Number of results to return per page. Default: 20, max: 100.
    ...
    def save(self, promotion_id, promotion, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save(promotion_id, promotion, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.save_with_http_info(promotion_id, promotion, **kwargs)
        else:
            (data) = self.save_with_http_info(promotion_id, promotion, **kwargs)
            return data

    def save_with_http_info(self, promotion_id, promotion, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save_with_http_info(promotion_id, promotion, callback=callback_function)
        ...
        all_params = ['promotion_id', 'promotion']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        # verify the required parameter 'promotion_id' is set
        if ('promotion_id' not in params) or (params['promotion_id'] is None):
            raise ValueError("Missing the required parameter `promotion_id` when calling `save`")
        # verify the required parameter 'promotion' is set
        if ('promotion' not in params) or (params['promotion'] is None):
            raise ValueError("Missing the required parameter `promotion` when calling `save`")
    ...
    def save_assignment(self, promotion_assignment, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save_assignment(promotion_assignment, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param PromotionAssignment promotion_assignment:  (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.save_assignment_with_http_info(promotion_assignment, **kwargs)
        else:
            (data) = self.save_assignment_with_http_info(promotion_assignment, **kwargs)
            return data

    def save_assignment_with_http_info(self, promotion_assignment, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save_assignment_with_http_info(promotion_assignment, callback=callback_function)
        ...
        all_params = ['promotion_assignment']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        for key, val in iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'promotion_assignment' is set
        if ('promotion_assignment' not in params) or (params['promotion_assignment'] is None):
            raise ValueError("Missing the required parameter `promotion_assignment` when calling `save_assignment`")
        ...
        body_params = None
        if 'promotion_assignment' in params:
            body_params = params['promotion_assignment']
