...
[**patch_from_user**](OrderApi.md#patch_from_user) | **PATCH** /orders/{direction}/{orderID}/fromuser | 
...
[**save**](OrderApi.md#save) | **PUT** /orders/{direction}/{orderID} | 
...
promo_code = 'promo_code_example' # str | Promo code of the promotion.
 ...
 **promo_code** | **str**| Promo code of the promotion. | 
...
# **approve**
> Order approve(direction, order_id, order_approval_info)
...
direction = 'direction_example' # str | Direction of the order, from the current user's perspective. Possible values: incoming, outgoing.
order_id = 'order_id_example' # str | ID of the order.
order_approval_info = OrderCloud.OrderApprovalInfo() # OrderApprovalInfo | 

try: 
    response = OrderApi.approve(direction, order_id, order_approval_info)
    print(response)
except ApiException as e:
 ...
 **direction** | **str**| Direction of the order, from the current user&#39;s perspective. Possible values: incoming, outgoing. | 
 **order_id** | **str**| ID of the order. | 
 **order_approval_info** | [**OrderApprovalInfo**](OrderApprovalInfo.md)|  | 
...
# **decline**
> Order decline(direction, order_id, order_approval_info)
...
try: 
    response = OrderApi.decline(direction, order_id, order_approval_info)
    print(response)
except ApiException as e:
...
> Order patch_billing_address(direction, order_id, partial_address)
...
try: 
    response = OrderApi.patch_billing_address(direction, order_id, partial_address)
    print(response)
except ApiException as e:
...
# **patch_from_user**
> Order patch_from_user(direction, order_id, partial_user)
...
try: 
    response = OrderApi.patch_from_user(direction, order_id, partial_user)
    print(response)
except ApiException as e:
    print("Exception when calling OrderApi->patch_from_user: %s\n" % e)
```
...
> Order patch_shipping_address(direction, order_id, partial_address)
...
try: 
    response = OrderApi.patch_shipping_address(direction, order_id, partial_address)
    print(response)
except ApiException as e:
...
# **save**
> Order save(direction, order_id, order)
...
try: 
    response = OrderApi.save(direction, order_id, order)
    print(response)
except ApiException as e:
    print("Exception when calling OrderApi->save: %s\n" % e)
```
