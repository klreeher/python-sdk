...
[**save**](CostCenterApi.md#save) | **PUT** /buyers/{buyerID}/costcenters/{costCenterID} | 
...
user_id = 'user_id_example' # str | ID of the user. (optional)
user_group_id = 'user_group_id_example' # str | ID of the user group. (optional)
level = 'level_example' # str | Level of the cost center assignment. Possible values: User, Group, Company. (optional)
page = 56 # int | Page of results to return. Default: 1 (optional)
page_size = 56 # int | Number of results to return per page. Default: 20, max: 100. (optional)
 ...
 **user_id** | **str**| ID of the user. | [optional] 
 **user_group_id** | **str**| ID of the user group. | [optional] 
 **level** | **str**| Level of the cost center assignment. Possible values: User, Group, Company. | [optional] 
 **page** | **int**| Page of results to return. Default: 1 | [optional] 
 **page_size** | **int**| Number of results to return per page. Default: 20, max: 100. | [optional] 
...
# **patch**
> CostCenter patch(buyer_id, cost_center_id, partial_cost_center)
...
buyer_id = 'buyer_id_example' # str | ID of the buyer.
cost_center_id = 'cost_center_id_example' # str | ID of the cost center.
partial_cost_center = OrderCloud.CostCenter() # CostCenter | 

try: 
    response = CostCenterApi.patch(buyer_id, cost_center_id, partial_cost_center)
    print(response)
except ApiException as e:
 ...
 **buyer_id** | **str**| ID of the buyer. | 
 **cost_center_id** | **str**| ID of the cost center. | 
 **partial_cost_center** | [**CostCenter**](CostCenter.md)|  | 
...
# **save**
> CostCenter save(buyer_id, cost_center_id, cost_center)
...
try: 
    response = CostCenterApi.save(buyer_id, cost_center_id, cost_center)
    print(response)
except ApiException as e:
    print("Exception when calling CostCenterApi->save: %s\n" % e)
```
...
# **save_assignment**
> save_assignment(buyer_id, cost_center_assignment)
...
CostCenterApi = OrderCloud.CostCenterApi
buyer_id = 'buyer_id_example' # str | ID of the buyer.
cost_center_assignment = OrderCloud.CostCenterAssignment() # CostCenterAssignment | 

try: 
    CostCenterApi.save_assignment(buyer_id, cost_center_assignment)
except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **buyer_id** | **str**| ID of the buyer. | 
 **cost_center_assignment** | [**CostCenterAssignment**](CostCenterAssignment.md)|  | 
