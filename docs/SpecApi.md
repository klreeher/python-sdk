...
[**save**](SpecApi.md#save) | **PUT** /specs/{specID} | 
[**save_option**](SpecApi.md#save_option) | **PUT** /specs/{specID}/options/{optionID} | 
...
# **create_option**
> SpecOption create_option(spec_id, spec_option)
...
spec_option = OrderCloud.SpecOption() # SpecOption | 

try: 
    response = SpecApi.create_option(spec_id, spec_option)
    print(response)
except ApiException as e:
 ...
 **spec_option** | [**SpecOption**](SpecOption.md)|  | 
...
# **patch**
> Spec patch(spec_id, partial_spec)
...
SpecApi = OrderCloud.SpecApi
spec_id = 'spec_id_example' # str | ID of the spec.
partial_spec = OrderCloud.Spec() # Spec | 

try: 
    response = SpecApi.patch(spec_id, partial_spec)
    print(response)
except ApiException as e:
...
# **patch_option**
> SpecOption patch_option(spec_id, option_id, partial_spec_option)
...
spec_id = 'spec_id_example' # str | ID of the spec.
option_id = 'option_id_example' # str | ID of the option.
partial_spec_option = OrderCloud.SpecOption() # SpecOption | 

try: 
    response = SpecApi.patch_option(spec_id, option_id, partial_spec_option)
    print(response)
except ApiException as e:
 ...
 **spec_id** | **str**| ID of the spec. | 
 **option_id** | **str**| ID of the option. | 
 **partial_spec_option** | [**SpecOption**](SpecOption.md)|  | 
...
try: 
    response = SpecApi.save(spec_id, spec)
    print(response)
except ApiException as e:
    print("Exception when calling SpecApi->save: %s\n" % e)
```
...
# **save_option**
> SpecOption save_option(spec_id, option_id, spec_option)
...
try: 
    response = SpecApi.save_option(spec_id, option_id, spec_option)
    print(response)
except ApiException as e:
    print("Exception when calling SpecApi->save_option: %s\n" % e)
```
...
> save_product_assignment(spec_product_assignment)
...
# create an instance of the API class
SpecApi = OrderCloud.SpecApi
spec_product_assignment = OrderCloud.SpecProductAssignment() # SpecProductAssignment | 

try: 
    SpecApi.save_product_assignment(spec_product_assignment)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **spec_product_assignment** | [**SpecProductAssignment**](SpecProductAssignment.md)|  | 
